...
def wiimote_state_callback(state_data):
    #rospy.loginfo("here be data %s", data.linear_acceleration_zeroed.x)
    #print ' data received'
    #print state_data.linear_acceleration_zeroed.x, state_data.linear_acceleration_zeroed.y
    #def computeAngle(accel_data):
